...
::::{.activity-container}
You have the
[following report](https://ttimbers.github.io/breast_cancer_predictor/doc/breast_cancer_predict_report.html)
and you have realized that there was an error in one of the calculations you did to generate it. This means that several results are going to be modified.
