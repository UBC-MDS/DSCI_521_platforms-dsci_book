...
We have already seen RStudio in [Lecture 0b](0-rstudio-orientation-intro.qmd).
...
Please see the
[Lecture 0b: Recommended RStudio Setup](0-rstudio-orientation-intro.qmd#recommended-rstudio-setup)
...
We saw this in the [Quarto and Git Hub Pages Lesson](4-quarto_github_pages.qmd).
