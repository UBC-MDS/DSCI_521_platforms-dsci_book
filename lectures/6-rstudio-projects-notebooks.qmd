...
output-file: rstudio-projects-notebooks.html
---
...
We have already seen RStudio in the [RStudio Orientation](0-rstudio-orientation-intro.qmd).
...
Please see the
[RStudio Orientation: Recommended RStudio Setup](0-rstudio-orientation-intro.qmd#recommended-rstudio-setup)
...
Going back to [first exercise of this lesson](#activity-1),
...
We saw this in the [Quarto and Git Hub Pages Lesson](3-quarto_github_pages.qmd).
...
1. [Jupyter Notebook (and Jupyter Book) Markdown](https://jupyterbook.org/en/stable/file-types/markdown.html):
   ...
   If you completed the tutorial from the orientation lessons,
