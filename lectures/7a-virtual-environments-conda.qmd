...
it does allow you to easily change between environments within jupyter lab,
but if you are not careful, you can end up installing packages in the
wrong environment or not realize you are using the wrong environment.
:::
