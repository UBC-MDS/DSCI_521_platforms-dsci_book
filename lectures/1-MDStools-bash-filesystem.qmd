...
::::
::::{.activity-container}
Which command should you run to search for a folder named find_me within the current directory and its subdirectories?
...
::::
::::{.activity-container}
Given that your current directory is /Users/Varada/canadian_languages, 
what is the correct command to navigate directly to /Users/Varada?
