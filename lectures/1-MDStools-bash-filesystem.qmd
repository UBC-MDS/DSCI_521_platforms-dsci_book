...
1. Extract value from data through reproducible and auditable processes.
2. Apply machine learning algorithms.
3. Analyze large volumes of often unstructured data to produce meaningful insights.
   <https://www.springboard.com/blog/data-science/data-science-definition/>
4. Get well paid.
::::
:::
...
::::
::::{.activity-container}
You have already learn how to use some commands using JupyterLab IDE.
Do you find it easier to use the command line or JupyterLab user interfase?
...
Would them be possible to use with the command `ls` instead of `cd`?
...
Explore the content of the folder `example_521`
using your favourite favourite file manager
(`Finder` for Mac, `File Explorer` for Windows, and any file manager in Linux)
Can you draw a diagram with the content of that folder?
