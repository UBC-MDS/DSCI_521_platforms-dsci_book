---
title: DSCI 521 Lecture 1 - Introduction to MDS software and Bash
jupyter: python3
---
...
By the end of this lecture, you will have learnt how to:

1. Recognize the directory hierarchy as it is commonly represented in diagrams, paths and in the file explorer software.
2. Distinguish common operators and representations of the different filesystem elements typically used on Bash. 
...
5. Use command-line arguments to produce alternative outputs of the commands.
...
Welcome to Computer Platforms on Data Science! 

This week we are going to learn about how to explore the filesystem, to use the command line and some other useful tools.
...
A.  ... extracting value from data through reproducible and auditable processes. X  
B.  ... applying machine learning algoritms.  
C.  ... analyzing large volumes of often unstructured data, with the goal of producing meaningful insights. (https://www.springboard.com/blog/data-science/data-science-definition/)  
D.  ... well paid.  
...
All these software are leading in their respective area,
and used by many big tech companies. 
Examples in R and Python include 

- Tensorflow from Google
- Pytorch from Facebook
- R Open from Microsoft
...
- Having access to the source code - you can learn and fix bugs (even closed source, Commercial Software has bugs, they are just harder to see and help fixing...).
...
You have already learn how to use some commands using JupyterLab IDE. Do you fiend easier to use the commands line or JupyterLab user interfase? 
...
My home directory is: `/Users/Florencia/`
The output of running `pwd` in the command line is: `/Users/Florencia/canadian_languages`

What is the problem if I run the command: `cd Users/Gittu`. How can I solve it?
