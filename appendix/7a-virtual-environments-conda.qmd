...
output-file: virtual-environments-conda.html
---

## Learning outcomes

1. Differenciate Python, Anaconda, MiniConda, Conda and `pip`
2. Manage packages and environments in Python using Conda
...
It would look similar to the output below.
...
Similarly, all your environments are installed within your `miniforge3` folder,
which is typically located in `~/miniforge3`
